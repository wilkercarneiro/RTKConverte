...
interface Gerado {
  ...
  folha?: string;
  avisos?: string[];
  /** planta A3 de cada gleba/parte (serviço com glebas); memorial e tabular por gleba saem nas peças técnicas */
  glebas?: { nome: string; planta_pdf: string | null; areaHa: number }[];
